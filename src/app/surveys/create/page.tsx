...
export default function SurveyPage() {
  ...
  const [questionCount, setQuestionCount] = useState<number>(0);      // ← NEW
  const [isModerated, setIsModerated]     = useState<boolean>(false); // ← NEW
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await createSurvey({
        ...
        objective,
        questions,
        questionCount,    // ← pass along
        isModerated,      // ← pass along
